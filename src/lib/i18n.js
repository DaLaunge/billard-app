...
const TRANSLATIONS = {
  en: {
    ...
    "Aktuelle Bestwerte der gesamten Gruppe aus allen bestätigten Einzel-Matches (bzw. dem bisherigen Rating-Verlauf beim Rating-Rekord) - wer hält gerade welchen Rekord?": "Current bests for the whole group across all confirmed singles matches (or the rating history so far for the rating record) - who currently holds which record?",
    "Übersicht": "Overview",
