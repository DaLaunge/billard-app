...
const TRANSLATIONS = {
  en: {
    ...
    "SMTP-Testmail": "SMTP test mail",
    "Verschickt eine einzelne Mail direkt über das konfigurierte SMTP-Konto (unabhängig von den Supabase-Auth-Mails) – zum gezielten Testen von Zustellung und Sendekapazität. Betreff/Text leer lassen für automatische Werte.": "Sends a single mail directly via the configured SMTP account (independent of Supabase Auth mails) – for targeted testing of delivery and sending capacity. Leave subject/text empty for automatic values.",
    "Empfänger-Adresse": "Recipient address",
    "Betreff (optional)": "Subject (optional)",
    "Mailtext (optional)": "Mail text (optional)",
    "Testmail versenden": "Send test mail",
    "Testmail gesendet.": "Test mail sent.",
    "Gültige Empfänger-Adresse nötig.": "Valid recipient address required.",
    "Sende ...": "Sending ...",
    ...
    "{n} von {m} sichtbar": "{n} of {m} visible",
    "Karte einblenden": "Show card",
    "Alle Karten einblenden": "Show all cards",
    "Alle einblenden": "Show all",
    "Karten": "Cards",
    "Reihenfolge, Spalte und Sichtbarkeit der Karten - fuer jeden Bildschirm. Ausgeblendete Karten holst du auch direkt auf dem jeweiligen Bildschirm ganz unten wieder zurueck.": "Order, column and visibility of every card, for each screen. You can also bring hidden cards back at the bottom of the screen they belong to.",
    "Nach oben": "Move up",
    "Nach unten": "Move down",
    "Spalte wechseln": "Change column",
    "Spalte: {col}": "Column: {col}",
    "Links": "Left",
    "Mitte": "Middle",
    "Rechts": "Right",
    "Erfolge (Fortschritt)": "Achievements (progress)",
    "Erfolge (alle)": "Achievements (all)",
    "Head-to-Head": "Head-to-head",
    "Beste Siegquote": "Best win rate",
    "Schnellstes Tempo": "Fastest pace",
    "Schnellstes 14/1-Tempo": "Fastest 14.1 pace",
    "Alle aufklappen": "Expand all",
    "Alle zuklappen": "Collapse all",
    "In die rechte Spalte verschieben": "Move to right column",
    "In die mittlere Spalte verschieben": "Move to middle column",
    "Rückgängig": "Undo",
    "Karte hierher ziehen, um sie in diese Spalte zu verschieben": "Drag a card here to move it into this column",
    ...
    "Podium": "Podium",
    "Einmal Platz 1-3 im Gesamt-Ranking erreicht": "Reached rank 1-3 in the overall ranking once",
    "Podestfels": "Podium Fixture",
    "4 Wochen auf Platz 1-3 im Ranking": "4 weeks at rank 1-3 in the ranking",
    "Podestlegende": "Podium Legend",
    "12 Wochen auf Platz 1-3 im Ranking": "12 weeks at rank 1-3 in the ranking",
    ...
    "Spiel(e) gegen den Ghost": "game(s) vs. the Ghost",
    "Turniersieg(e)": "tournament win(s)",
    "zweite Plätze": "2nd-place finishes",
    "dritte Plätze": "3rd-place finishes",
    "Tage": "days",
    "{n} Spiele gegen den Ghost": "{n} games vs. the Ghost",
    "{n}× Platz 1": "{n}× 1st place",
    "{n}× Platz 2": "{n}× 2nd place",
    "{n}× Platz 3": "{n}× 3rd place",
    "Dabei seit {n} Tagen": "Member for {n} days",
    ...
    "Zurücksetzen": "Reset",
    "Setzt Kugelfarbe, Design, Startseite sowie verschobene und ausgeblendete Karten auf die Standardeinstellungen zurück.": "Resets ball color, design, home screen, and any rearranged or hidden cards to their default settings.",
    ...
    "Push-Nachrichten kommen auch, wenn die App geschlossen ist. Ist sie offen, erscheint stattdessen ein Hinweis in der App.": "Push notifications arrive even when the app is closed. While it's open, you get an in-app alert instead.",
    "Gilt nur auf diesem Gerät.": "Applies to this device only.",
    "Auf dem iPhone gehen Push-Nachrichten nur, wenn die App auf dem Home-Bildschirm installiert ist.": "On iPhone, push notifications only work once the app is installed on the Home Screen.",
    "Benachrichtigungen sind für diese App im Browser/System blockiert.": "Notifications are blocked for this app in your browser/system settings.",
    "Dieser Browser unterstützt keine Push-Nachrichten.": "This browser doesn't support push notifications.",
    "Ansehen": "View",
    ...
    "Dieser Code bleibt gültig – es können also mehrere Leute gleichzeitig damit beitreten. Wer damit beitritt, wird dir als geworbener Spieler gutgeschrieben; dafür gibt es eigene Erfolge. Mit \"Neu\" bekommst du einen frischen Code, der alte gilt dann nicht mehr.": "This code stays valid – so several people can join with it at the same time. Whoever joins with it is credited to you as a recruited player; there are dedicated achievements for that. \"New\" gives you a fresh code and retires the old one.",
    "Neuen Code erzeugen": "Generate new code",
    "Neuen Code erzeugen? Der bisherige QR-Code funktioniert danach nicht mehr.": "Generate a new code? The current QR code will stop working.",
    "Neuer Code erstellt.": "New code created.",
    ...
    "Rating nach einem Fargo-ähnlichen Elo-System: mehr Punkte = besser, 100 Punkte Unterschied entsprechen ungefähr einer Gewinnchance von 2:1. Ohne bestätigtes Match bewegt sich das Rating mit der Zeit wieder Richtung 500 (Startwert). Unter 10 Spielen gilt ein Rating als vorläufig, ohne Match seit 180 Tagen als inaktiv.": "Rating on a Fargo-like Elo system: more points = better, a 100-point difference is roughly a 2:1 win chance. Without a confirmed match, a rating drifts back toward 500 (the starting value) over time. Under 10 games a rating counts as provisional, and as inactive after 180 days without a match.",
    "Anteil gewonnener Einzel-Matches (Siege ÷ Spiele) in der aktuell gewählten Disziplin. Um verlässlich zu sein, zählt die Quote erst ab 10 Spielen in dieser Auswahl.": "Share of won singles matches (wins ÷ games) in the currently selected discipline. To be reliable, the rate only counts from 10 games onward in this selection.",
    "Wie viele Einzel-Matches in Folge gewonnen wurden, seit der letzten Niederlage in der aktuell gewählten Disziplin.": "How many singles matches were won in a row since the last loss, in the currently selected discipline.",
    "Schnellstes Tempo (Ø pro Spiel)": "Fastest pace (avg. per game)",
    "Schnellstes 14/1-Tempo (Ø pro Kugel)": "Fastest 14.1 pace (avg. per ball)",
    "Durchschnittliche Zeit pro Einzelspiel bei 8-, 9- und 10-Ball-Matches mit gespeichertem Protokoll (nur Matches, die über den digitalen Zähler gemeldet wurden). Niedrigster Wert zuerst. Nur Spieler mit mindestens einem auswertbaren Match werden gelistet.": "Average time per individual game in 8-, 9- and 10-ball matches with a saved protocol (only matches reported via the digital counter). Lowest value first. Only players with at least one usable match are listed.",
    "Durchschnittliche Zeit pro versenkter Kugel bei 14/1-Endlos-Matches mit gespeichertem Protokoll. Fouls zählen nicht mit. Niedrigster Wert zuerst. Nur Spieler mit mindestens einem auswertbaren Match werden gelistet.": "Average time per potted ball in 14.1 continuous matches with a saved protocol. Fouls don't count. Lowest value first. Only players with at least one usable match are listed.",
    ...
    "14/1": "14/1",
    "Dein Rang": "Your rank",
    "Du bist in dieser Liste nicht vertreten.": "You're not on this list.",
    "Turnierleitung": "Tournament organizer",
    "Live": "Live",
    ...
    "Planung": "Planning",
    "Planung erstellen": "Add a plan",
    "Wann bist du voraussichtlich verfuegbar? Andere koennen dir dann direkt eine Nachricht schicken - spart laestiges Hin-und-Her bei der Terminfindung.": "When are you likely to be free? Others can message you directly - saves the back-and-forth of finding a date.",
    "Datum": "Date",
    "Hinweis (optional), z. B. 'Bin flexibel, meldet euch'": "Note (optional), e.g. 'I'm flexible, let me know'",
    "Planung eintragen": "Add plan",
    "Deine Planung verschwindet automatisch nach dem gewaehlten Tag.": "Your plan disappears automatically after the chosen day.",
    "Meine Planungen:": "My plans:",
    "Weitere Planungen:": "Other plans:",
    "Noch keine Planungen. Leg die erste an - dein Eintrag ist fuer alle sichtbar.": "No plans yet. Be the first - your entry is visible to everyone.",
    "Planung löschen": "Delete plan",
    "Bin interessiert": "I'm interested",
    "Interessiert": "Interested",
    "Nachricht (optional), z. B. 'Passt mir gut'": "Message (optional), e.g. 'Works for me'",
    " ist interessiert!": " is interested!",
    "interessiert": "interested",
    "Planung eingetragen!": "Plan added!",
    "Planung geloescht.": "Plan deleted.",
    ...
    "Gespeichert!": "Saved!",
    "Bestätigt!": "Confirmed!",
    "Ist {name} noch da? Handy weiterreichen und direkt bestätigen.": "Is {name} still here? Hand over the phone and confirm right away.",
    "Jetzt direkt bestätigen": "Confirm right now",
    "Bestätige ...": "Confirming ...",
    ...
    "Lade ...": "Loading ...",
    "Update erforderlich": "Update required",
    "Diese Version der App ist veraltet. Die neue Version wird geladen ...": "This version of the app is outdated. Loading the new version ...",
    "Falls das nicht klappt: App komplett schließen und neu öffnen.": "If that doesn't work: close the app completely and open it again.",
    "Jetzt neu laden": "Reload now",
    "Unfertiges Match": "Unfinished match",
    "Gegen {opp} · {disc} · Stand {score}": "Against {opp} · {disc} · score {score}",
    ...
    "Keine Mindestversion gesetzt.": "No minimum version set.",
    "„–“ = App seit v377 nicht geöffnet oder noch eine ältere Version.": "“–” = app not opened since v377, or still an older version.",
    "Speichere ...": "Saving ...",
    "Zurück": "Back",
    ...
    "Erreicht": "Unlocked",
    "Gesperrt": "Locked",
    "Keine passenden Erfolge gefunden.": "No matching achievements found.",
    ...
    "Geworben": "Recruited",
    "Höchster Sieg": "Biggest win",
    "Höchster Sieg (14/1)": "Biggest win (14.1)",
    "Höchstes Rating erreicht": "Highest rating reached",
    "Meiste Matches gesamt": "Most matches overall",
    ...
    "Meiste Matches, die eine Person gegen ein und denselben Gegner gewonnen hat.": "Most matches a single person has won against one and the same opponent.",
    "Meiste an einem einzigen Kalendertag gewonnene Matches.": "Most matches won on a single calendar day.",
    "Anzahl neuer Mitglieder, die über den eigenen Einladungslink beigetreten sind.": "Number of new members who joined via this person's own invite link.",
    "Größter Punkte- bzw. Rack-Abstand in einem Einzel-Match (alle Disziplinen außer 14/1 Endlos). Bei Gleichstand zählt, wer dieses Ergebnis zuerst erreicht hat.": "Biggest point or rack margin in a singles match (all disciplines except 14.1 continuous). In case of a tie, whoever reached this result first holds the record.",
    "Größter Punkteabstand in einem Einzel-Match der Disziplin 14/1 Endlos (zählt in Punkten, daher meist deutlich höhere Werte als in anderen Disziplinen). Bei Gleichstand zählt, wer dieses Ergebnis zuerst erreicht hat.": "Biggest point margin in a 14.1 continuous singles match (counted in points, so usually much higher than in other disciplines). In case of a tie, whoever reached this result first holds the record.",
    "Höchstes je erreichtes Gesamt-Rating, aus dem täglichen Verlauf oder dem aktuellen Stand.": "Highest overall rating ever reached, from the daily history or the current standing.",
    "Meiste bestätigte Matches insgesamt, über alle Disziplinen.": "Most confirmed matches overall, across all disciplines.",
    "Kürzeste Gesamtdauer eines Matches (erster bis letzter Zeitstempel im gespeicherten Zeit-Protokoll; bei Winner Stays die reine Spielzeit dieser Paarung), unabhängig von der Disziplin. Nur Matches mit digitalem Zähler-Protokoll zählen.": "Shortest total duration of a match (first to last timestamp in the saved time log; for Winner Stays, the pure playing time of that pairing), regardless of discipline. Only matches with a digital counter log count.",
    "Längste Gesamtdauer eines Matches (erster bis letzter Zeitstempel im gespeicherten Zeit-Protokoll; bei Winner Stays die reine Spielzeit dieser Paarung), unabhängig von der Disziplin. Nur Matches mit digitalem Zähler-Protokoll zählen.": "Longest total duration of a match (first to last timestamp in the saved time log; for Winner Stays, the pure playing time of that pairing), regardless of discipline. Only matches with a digital counter log count.",
    "Übersicht": "Overview",
    ...
    "Reine Spielzeit": "Pure playing time",
    "Zwischen zwei Begegnungen desselben Paares spielen bei Winner Stays andere am Tisch - diese Zeit zählt hier nicht mit.": "In Winner Stays, others play at the table between two meetings of the same pairing - that time is not counted here.",
    ...
    "{winner} gewinnt {s1}:{s2}.": "{winner} wins {s1}:{s2}.",
    "Läuft": "Running",
    ...
    "Eingetragen!": "Entered!",
    "Als Turnierleitung eingetragen – gilt sofort als bestätigt.": "Entered as organizer – counts as confirmed immediately.",
    ...
    "Turnier bestätigen": "Confirm tournament",
    "Turnier endgültig bestätigen? Danach sind keine Ergebnis-Korrekturen mehr möglich.": "Confirm the tournament as final? After this, no result corrections will be possible anymore.",
    "Turnier bestätigt - Korrekturen sind jetzt gesperrt.": "Tournament confirmed - corrections are now locked.",
    "Ergebnisse bestätigt": "Results confirmed",
    "Korrekturen noch möglich": "Corrections still possible",
    "Anmeldung offen": "Registration open",
    "Turnier erstellt – Anmeldung ist jetzt offen.": "Tournament created – registration is now open.",
    "Nach dem Anlegen ist das Turnier offen zur Anmeldung - Spieler melden sich selbst an, du startest, sobald alle da sind.": "Once created, the tournament is open for registration - players sign themselves up, you start it once everyone's there.",
    ...
    "Turnier jetzt starten? Der Turnierbaum wird aus den aktuell angemeldeten Spielern ausgelost.": "Start the tournament now? The bracket will be drawn from the currently registered players.",
    "Turnier gestartet.": "Tournament started.",
    "Start rückgängig machen": "Undo start",
    "Start rückgängig machen und zurück zur Anmeldung?": "Undo the start and go back to registration?",
    "Start rückgängig gemacht.": "Start undone.",
    "Nichterscheinen melden": "Report no-show",
    "{name} nicht erschienen": "{name} did not show up",
    "Nichterscheinen eingetragen.": "No-show recorded.",
    "Kommen beide nicht, kommt niemand von ihnen weiter - die Stelle im Baum wird zum Freilos.": "If neither shows up, neither advances - this bracket spot becomes a bye instead.",
    "Nicht gewertet - beide nicht erschienen": "Not scored - both no-shows",
    "Kompletter Turnierbericht": "Full tournament report",
    "Turnierbericht": "Tournament report",
    "Platz": "Rank",
    "Spieler": "Player",
    "Games +/-": "Games +/-",
    "Zeit am Tisch": "Time at the table",
    "Chronologischer Match-Log": "Chronological match log",
    "Kompakt": "Compact",
    "Vollständig": "Full",
    "Kompakt: Endstand, Höchstserie, Schnitt und Zeit am Tisch je Match.": "Compact: final score, high run, average and time at the table per match.",
    "Vollständig: komplettes Aufnahme-/Punkte-Protokoll je Match, wie in der einzelnen Match-Ansicht.": "Full: the complete inning/point log per match, like the single match view.",
    "Höchstserie": "High run",
    "Turnierverlauf": "Tournament bracket",
    "Partie": "Match",
    ...
    "Hin & Rück": "Home & away",
    "Abschluss": "Finish",
    "Finalrunde": "Final round",
    "Nur Tabelle": "Standings only",
    "Finale (Top 2)": "Final (top 2)",
    "Halbfinale (Top 4)": "Semifinal (top 4)",
    "Viertelfinale (Top 8)": "Quarterfinal (top 8)",
    "Für diese Playoff-Größe werden mindestens {n} Teilnehmer benötigt.": "This playoff size needs at least {n} participants.",
    "Playoff-Größe darf nicht größer als die Teilnehmerzahl sein.": "Playoff size can't be larger than the number of participants.",
    "Achtelfinale": "Round of 16",
    "Viertelfinale": "Quarterfinal",
    "Halbfinale": "Semifinal",
    "Du bist dran!": "You're up!",
    "gegen {name}": "vs {name}",
    "Tisch wird noch zugeteilt": "Table not assigned yet",
    "Später": "Later",
    "Zum Turnier": "Go to tournament",
    ...
    "Winner Stays": "Winner Stays",
    "Neue Runde": "New round",
    "Name der Runde": "Round name",
    "Modus": "Mode",
    "Tisch (optional)": "Table (optional)",
    "Teilnehmer fügst du danach direkt in der Runde hinzu.": "You can add participants directly in the round afterwards.",
    "Runde anlegen": "Create round",
    "Winner-Stays-Runde erstellt.": "Winner Stays round created.",
    "Noch keine Winner-Stays-Runde.": "No Winner Stays round yet.",
    "Keine Runden in diesem Filter.": "No rounds in this filter.",
    "Am Tisch": "At the table",
    "Verteidigt": "Defending",
    "Herausforderer": "Challenger",
    "Live-Rangliste": "Live standings",
    "Warteschlange": "Queue",
    "Runde beenden": "End round",
    "Runde löschen": "Delete round",
    ...
    "Team hinzugefügt.": "Team added.",
    "Teilnehmer hinzugefügt.": "Participants added.",
    "Erste Person": "First person",
    "Zweite Person": "Second person",
    "Noch keine Teilnehmer.": "No participants yet.",
    "Noch nicht genug Teilnehmer - mindestens zwei nötig, um zu spielen.": "Not enough participants yet - at least two are needed to play.",
    "Diese Person/dieses Team aus der Runde nehmen?": "Remove this person/team from the round?",
    "Unentschieden gibt es beim Billard nicht.": "There's no draw in billiards.",
    "Ein Tisch, mehrere Leute: der Sieger bleibt, der Verlierer geht ans Ende der Schlange - funktioniert mit 3 oder beliebig vielen Personen, auch im Doppel.": "One table, several people: the winner stays, the loser goes to the back of the queue - works with 3 or any number of people, doubles too.",
    "{n} Teilnehmer hinzufügen": "Add {n} participants",
    ...
    "Kein Protokoll vorhanden - wurde vermutlich nachträglich als Ergebnis eingetragen.": "No protocol available - was likely entered as a result after the fact.",
    "Wer hat das eingetragen, und wann?": "Who entered this, and when?",
    "Angabe bearbeiten": "Edit note",
    "Angabe hinzufügen": "Add note",
    'z. B. "Von Stefan am 17.09. laut Zettel-Mitschrift eingetragen."': 'e.g. "Entered by Stefan on 09/17 from a paper scoresheet."',
    "Nur die Turnierleitung oder ein Admin kann das eintragen.": "Only the tournament organizer or an admin can enter this.",
    "Aussetzen": "Sit out",
    "Ausgesetzt.": "Sat out.",
