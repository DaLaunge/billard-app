...
const TRANSLATIONS = {
  en: {
    ...
    "Karten": "Cards",
    "Welche Karten sollen auf welchem Bildschirm zu sehen sein? Ausgeblendete Karten holst du auch direkt auf dem jeweiligen Bildschirm ganz unten wieder zurueck.": "Which cards should be visible on which screen? You can also bring hidden cards back at the bottom of the screen they belong to.",
