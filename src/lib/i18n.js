...
const TRANSLATIONS = {
  en: {
    ...
    "Kürzeste Gesamtdauer eines Matches (erster bis letzter Zeitstempel im gespeicherten Zeit-Protokoll), unabhängig von der Disziplin. Nur Matches mit digitalem Zähler-Protokoll zählen.": "Shortest total duration of a match (first to last timestamp in the saved time log), regardless of discipline. Only matches with a digital counter log count.",
    "Längste Gesamtdauer eines Matches (erster bis letzter Zeitstempel im gespeicherten Zeit-Protokoll), unabhängig von der Disziplin. Nur Matches mit digitalem Zähler-Protokoll zählen.": "Longest total duration of a match (first to last timestamp in the saved time log), regardless of discipline. Only matches with a digital counter log count.",
    "Übersicht": "Overview",
