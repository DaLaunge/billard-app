...
export default function Ball({ color, label, size = 44, medal = null, badge = null }) {
  ...
  return (
    <div className={"ball" + (medal ? ` ${medal}-ring` : "")} style={{ width: size, height: size, background: color }}>
